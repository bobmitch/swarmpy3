...
atlas = pyglet.image.atlas.TextureAtlas(width=2048,height=2048)	# atlas for automatic texture packing into single texture
...
class slowTower:
	def __init__ (self, position):
		...
		self.base_sprite=pyglet.sprite.Sprite(slow_tower1_base_texture, x=position[0], y=position[1])
		self.base_sprite.scale = 0.075
	...
	def get_upgrade(self):
		return slowTower (copy.copy(self.pos))
...
def on_draw():
	...
	slow_tower1_base_sprite.x = amouse.map_x
	slow_tower1_base_sprite.y = amouse.map_y
	slow_tower1_base_sprite.draw ()
...
slow_tower1_base_image = pyglet.image.load ('base.png')
slow_tower1_base_texture = atlas.add (slow_tower1_base_image)
slow_tower1_base_sprite = pyglet.sprite.Sprite(slow_tower1_base_texture)
slow_tower1_base_sprite.scale = 0.075

slow_tower1_turret_image = pyglet.image.load ('slow_tower_turret.png')
slow_tower1_turret_texture = atlas.add (slow_tower1_turret_image)
slow_tower1_turret_sprite = pyglet.sprite.Sprite(slow_tower1_turret_texture)
